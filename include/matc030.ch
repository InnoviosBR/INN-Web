	...
	#define STR0047 "Espere. Filtrando registros."
		...
		#define STR0028 "Armazem: "
		#define STR0029 "Selecionando Registros ..."
		#define STR0030 "Ident               "
		#define STR0031 "Este programa ira imprimir a Consulta do Produto selecionado"
		#define STR0032 "informando as movimentacoes de estoque com seus respectivos"
		#define STR0033 "custos, saldos iniciais e saldos finais."
		#define STR0034 "Zebrado"
		#define STR0035 "Administracao"
		#define STR0036 "CONSULTA AO KARDEX"
		#define STR0037 "Endereco       "
		#define STR0038 "Serie               "
		#define STR0039 "Atencao"
		#define STR0040 "Ao alterar o armazem o custo medio unificado sera desconsiderado."
		#define STR0041 "Confirma"
		#define STR0042 "Abandona"
		#define STR0043 "Dados do Grafico"
		#define STR0044 "Saldo pagina Anterior"
		#define STR0045 "Lote        "
		#define STR0046 "Sub-Lote"
		#define STR0047 "Aguarde. Filtrando registros."
	#endif
#endif
